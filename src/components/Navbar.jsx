    ...
    <nav ref={fadeInLeft}>
      <div className="bg-white">
        <ul className="d-flex justify-content-end align-items-center navbar-nav flex-row d-none d-lg-flex">
          <li className="nav-item mx-4 custom-trap-medium">
          ...
          <li className="nav-item mx-4 me-5 custom-pink-color custom-trap-medium">
            <a href="#" className="nav-link ">
              Log in
            </a>
          </li>
        ...
        <div className="container-fluid">
          ...
          <div className="collapse navbar-collapse" id="navCollapse">
            ...
            <div className="ms-auto">
              <button className="btn text-dark custom-pink-btn mx-3 rounded-4 px-3 py-2 fw-bold pink-bg-btn ">
                Get Started
              </button>
              <button className="btn btn-dark mx-3 px-3 py-2 text-dark bg-white rounded-4 fw-bold white-bg-btn mt-lg-3 mt-0 mt-xxl-1">
                Product Tour
              </button>
            </div>
          </div>
